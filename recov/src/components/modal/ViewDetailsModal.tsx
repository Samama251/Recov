...
export const ViewDetailsModal: React.FC<ViewDetailsModalProps> = ({ isOpen, onClose, item }) => {
        ...
        <div className={`fixed inset-0 flex items-center justify-center z-50 transition-opacity duration-200 ease-in ${modalClass}`}
            ...
            <main key="1"
                ...
                <Card className="p-2 rounded-3xl">
                    <CardContent>
                        <h1 className="text-3xl pl-2 py-4 font-bold tracking-tighter sm:text-4xl md:text-4xl">{item.status === 'Lost' ? 'Lost Item' : 'Item Found'}</h1>
                        <p className="text-gray-500 pl-2 text-xl mb-3 dark:text-gray-400 max-w-[650px]">{item.status === 'Lost' ? 'Details of the item that was reported as lost.' : 'Details of the item that was reported as found.'}</p>
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="pl-5">
                                ...
                                <p className="text-xl text-gray-500 pl-1 mb-2">Category: {item.category}</p>
                        ...
                        <div className="flex justify-between mt-4">
                            ...
                            <Button
                                ...
                                onClick={handleClaimClick}>Claim</Button>
                        </div>
                    </CardContent>
                </Card>
            </main>
