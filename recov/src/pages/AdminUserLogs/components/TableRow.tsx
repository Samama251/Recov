    ...
    return (
        <tr className="border-b-2 p4 p-0">
            ...
            <td className="px-4  sm:px-6">
                <div>
                    <p className="text-xl">{data.item.title}</p>
            ...
            <div >
                <td >
                    <div
                        className="px-1 py-9 flex flex-col items-start space-y-2 sm:flex-row sm:items-center sm:space-y-0 sm:space-x-5 sm:px-6">
                        <h1 className="text-xl mt-0 pr-36">{data.timestamp}</h1>
                        <Button
