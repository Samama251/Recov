...
export const Header: React.FC = () => {
  ...
  return (
    <header className={`flex flex-col items-center justify-between sm:flex-row ${darkMode ? 'dark' : ''}`}>
      <div>
        <div className="flex items-center sm:text-left">
          <PageIcon className="h-24 w-24 mr-4" />{' '}
          <h1 className={`text-5xl text-left font-bold ${darkMode ? 'text-gray-100' : 'text-gray-900'}`}>
            Welcome to Lost & Found
            <p className={`text-2xl mt-2 ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
      ...
      <div className="flex items-center space-x-5 mt-4 sm:mt-0">
        <Toggle
          ...
          className={`w-20 h-14 ${darkMode ? 'bg-gray-800 text-gray-100' : 'bg-white text-gray-900'}`}
          variant="outline"
        ...
        <Button
          className={`h-14 ${darkMode ? 'bg-gray-800 text-gray-100' : 'bg-white text-gray-900'}`}
          variant="outline"
        >
